...
import ru.gb.exchangemodels.models.Actions.Action;
...
public class MainController implements Initializable {
    ...
    public void hostCopyFile() {
        try {
          ...
          /*  log.debug("File {} is copied", getSelectedHostItem());*/
            ...
            System.out.println("Cant copy file: {}"+ getSelectedHostItem());
        }
    }
    ...
    private String[] getServerAddress() {
        ...
        if (connection.length != 2) {
            ...
            System.out.println("Error server address or port");
    ...
    public void enterClientDir() {
        try {
            ...
            System.out.println("File create/read on host error ");
        }
